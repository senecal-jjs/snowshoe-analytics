...
api.add_resource(PremierLeague, '/odds-machine/api/v1/premier-league', endpoint = 'premier_league')
api.add_resource(NFL, '/odds-machine/api/v1/nfl', endpoint = 'nfl')
api.add_resource(NBA, '/odds-machine/api/v1/nba', endpoint = 'nba')
